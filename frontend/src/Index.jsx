            ...
            <section
                className="flex flex-col bg-green-800 h-full w-screen">
                    <div className="relative h-auto w-full">
                        <img src="/media/banners/banner.svg" alt="" className="h-screen w-full" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet"/>               
                        <div
                            className="absolute flex flex-col text-white top-8 left-4 w-full z-20 sm:w-1/2">
                                ...
                                Manage my farm produces, monitor profits, visualize metrices with a pocket friendly budget of Ksh. 30.00 per month.
